...
Проект представляет собой магазин компании, занимающейся перевозкой грузов с удобным поиском. Также в приложении реализовано добавление и удаление из корзины, авторизация пользователя.
